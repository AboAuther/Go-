...
{
    public class PersonelAdminService
    {
        #region 常量,变量的定义
        ...
        public bool CheckPersonelAdminLogin(string name, string password)
        {
            ...
            stringBuilder.AppendLine("select * from personel_admin");
        ...
        public int AddPersonelAdmin(personel_admin admin)
        {
            //创建SQL语句
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.AppendLine("insert into personel_admin");
        ...
        public int ChangePassword(string jobid, string password)
        {
            //创建SQL语句
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.AppendLine("update personel_admin");
